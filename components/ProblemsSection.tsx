...
const PROBLEMS=[
  ...
  {icon:<AlertTriangle size={22}/>,title:'Farms and agricultural sites need special treatment',body:'A borehole pump drawing 1.1 kW while running can demand 3–4 kW when it starts. If your inverter isn\'t sized for that startup surge, it will trip every single time the pump kicks on.',stat:'The agricultural sizing tool accounts for motor starting currents.',color:'#8b5cf6'},
  {icon:<ShieldOff size={22}/>,title:'Every company that reviews your quote also wants to sell you something',body:'There is no such thing as a free and unbiased review from a company that sells equipment. VoltSage earns nothing from the panels, inverters or batteries you buy.',stat:'No equipment sold. No commissions. Just engineering.',color:'#ec4899'},
]
